...
import { Votes } from "ui/atoms/votes";
...
const Tile = ({
  ...
  return (
    ...
    >
      ...
      <TileContent>
        <Title oversize={oversize} person={person}>
          {title}
        </Title>
        {subtitle && (
          <SubTitle oversize={oversize} person={person}>
            {subtitle}
          </SubTitle>
        )}
          ...
          <Tags>
            {genres &&
              ...
              genreIds.map((genreId) => (
                <Tag key={genreId}>
                  {genres[genres.findIndex(({ id }) => id === genreId)]?.name}
                </Tag>
              ))}
          </Tags>
        )}
        ...
        {!person && !oversizepersontile && (
          <Votes votes={votes} rating={rating} />
        )}
      </TileContent>
